                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body ">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <a href="{{ route('matieres.index') }}" class="btn btn-sm btn-secondary "><i
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <div class="form-control" name="nom" id="nom" type="texte"
                                             style="background-color : #ececec;">{{ $matiere->intitule }}</div>
                                    </div>
                                </div>
                            </div>
                            <!-- Fin Nom -->
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-7">
                                    <div class="form-group">
                                        <div class="form-control" name="promotion" id="promotion" type="texte"
                                             style="background-color : #ececec;">{{ $matiere->promotion->intitule }}</div>
                                    </div>
                                </div>
                            </div>
