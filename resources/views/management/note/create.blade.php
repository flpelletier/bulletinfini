    ...
    <form class="form-horizontal" action="{{route("note.create")}}" method="post">
        ...
        <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-group">
                                ...
                                <textarea required name="description" class="form-control" rows="1" placeholder="Enter ..."></textarea>
                            </div>
                        </div>
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <select name="coef" class="custom-select rounded-0" id="exampleSelectRounded0">
                                    @for($i = 1 ; $i <20 ; $i++) <option>{{$i}}</option>
                                        @endfor
                                </select>
                            </div>
                        </div>
            ...
            <div class="form-group row">
                <label for="inputEmail3" class="col-sm-2 col-form-label">{{strtoupper($eleve->nom) ." " .strtolower($eleve->prenom) }}</label>
                <div class="col-sm-10">
                    <input type="number" max="20" class="form-control" name="note_{{$eleve->id}}" placeholder="Note">
                </div>
            </div>
            @endforeach
        </div>
