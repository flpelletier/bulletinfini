...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.23/af-2.3.5/b-1.6.5/b-html5-1.6.5/b-print-1.6.5/r-2.2.6/sb-1.0.1/datatables.min.css"/>
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="" class="brand-link">
            <img src="{{url('./images/icon.ico')}}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
        ...
        <div class="sidebar">
            ...
            <nav class="mt-2 text-left ">
                <ul class="nav nav-pills nav-sidebar   list-inline flex-column" data-widget="treeview" role="menu"
    ...
    <footer class="main-footer">
        ...
        <strong id="copyright">Copyright &copy;
            ...
            <a>Bulletinfini</a>.</strong> Tout droits réservés.
    </footer>
</div>
<!-- ./wrapper -->
...
<script type="text/javascript"
        src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.23/af-2.3.5/b-1.6.5/b-html5-1.6.5/b-print-1.6.5/r-2.2.6/sb-1.0.1/datatables.min.js"></script>
<script>
